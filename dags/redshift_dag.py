...
step5e = PythonOperator(task_id='counts_hercules',python_callable= insert_counts,op_kwargs={"module_name":"Workday Hercules","schemaname": counts_schema,"conn_id":Variable.get("conn_etl")}, dag=etl_dag)
step5f = PythonOperator(task_id='send_email_hercules',python_callable= email_job,op_kwargs={"module_name":"Workday Hercules","client_name":"Suffolk","recipients":"etlsupp@heliocampus.com","conn_id":Variable.get("conn_etl"), "schemaname": counts_schema,"conn_id":Variable.get("conn_etl"), "schemaname": counts_schema}, dag=etl_dag)
